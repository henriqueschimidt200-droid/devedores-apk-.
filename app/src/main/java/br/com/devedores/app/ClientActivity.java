...
public class ClientActivity extends Activity {
    ...
    void build(){
        ...
        if (getIntent().getBooleanExtra("openPayment", false)) { new Handler(Looper.getMainLooper()).postDelayed(this::chooseLoanForPayment, 250); }
    }
